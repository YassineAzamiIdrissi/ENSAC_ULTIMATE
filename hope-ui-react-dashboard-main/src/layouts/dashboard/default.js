    ...
    <Fragment>
      ...
      <main className="main-content">
        ...
        <div className="py-0 conatiner-fluid content-inner mt-n5">
          {/* <DefaultRouter /> */}
          {/* c'est ici ou on projet le lien dashboard */}
          <Outlet />
        </div>
        <div className="btn-download">
          <Link
            className="btn btn-success px-3 py-2"
            to="https://iqonic.design/product/admin-templates/hope-ui-admin-free-open-source-bootstrap-admin-template/"
            target="_blank"
          >
            <svg
              className="icon-24"
      ...
      <SettingOffCanvas />
      <Link
        className="btn btn-fixed-end btn-secondary btn-icon btn-dashboard"
        to="/landing-modules/home"
        target="_blank"
      >
        Landing Pages
      </Link>
