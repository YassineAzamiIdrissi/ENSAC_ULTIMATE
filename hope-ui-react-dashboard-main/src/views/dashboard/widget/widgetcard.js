            ...
            <Card.Body>
              ...
              <div className="d-flex  justify-content-start align-items-center mb-3">
                <div className="pe-3">
                  <Image
                    src={avatars2}
                    className="rounded-circle p-1 bg-soft-danger"
                    width="60"
                    height="60"
                    alt="1"
                  />
              ...
              <div>
                <small>
                  it is impossible to withhold education from the respective
                  mind as
                </small>
                <small>
                  it is impossible to force it uopen the unreasoning
                </small>
              </div>
              <div className="pt-4">
            ...
            <Card.Body>
              ...
              <div className="d-flex justify-content-start align-items-center mt-4">
                <div className="pe-3">
                  <Image
                    src={avatars4}
                    className="rounded-circle bg-soft-danger p-1"
                    width="50"
                    height="50"
                    alt="1"
                  />
              ...
              <div className="user-post-data">
                <div className="d-flex flex-wrap">
                  <div className="media-support-user-img me-3">
                    <Image
                      className="rounded-circle p-1 bg-soft-danger img-fluid avatar-60"
                      src={avatars2}
                      alt=""
                    />
                  </div>
              ...
              <ul className="media-story m-0 p-0">
                <li className="d-flex mb-4 align-items-center active">
                  <Image
                    src={avatars4}
                    alt="story-img"
                    className="avatar-50 rounded-circle p-1 bg-soft-danger img-fluid"
                  />
