                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        ...
                        data-copy-target="#svg-container-1"
                        title="Copy"
                      >
                        Copy
                      </Button>
                ...
                <div className="icon-box">
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-copy-target="#svg-container-2"
                        data-toggle="copy"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        ...
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        data-copy-target="#svg-container-3"
                        data-toggle="copy"
                        title="Copy"
                      >
                        Copy
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        ...
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        data-copy-target="#svg-container-4"
                        data-toggle="copy"
                        title="Copy"
                      >
                        Copy
                ...
                <div className="icon-box">
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-copy-target="#svg-container-6"
                        data-toggle="copy"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                ...
                <div className="icon-box">
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-copy-target="#svg-container-7"
                        data-toggle="copy"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                ...
                <div className="icon-box">
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-copy-target="#svg-container-8"
                        data-toggle="copy"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                ...
                <div className="icon-box">
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-copy-target="#svg-container-9"
                        data-toggle="copy"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                ...
                <div className="icon-box">
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-copy-target="#svg-container-11"
                        data-toggle="copy"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                ...
                <div className="icon-box">
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-copy-target="#svg-container-12"
                        data-toggle="copy"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                ...
                <div className="icon-box">
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-copy-target="#svg-container-13"
                        data-toggle="copy"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-14"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-15"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-16"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-17"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-18"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-19"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-20"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-21"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                ...
                <div className="icon-box">
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-22"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div id="svg-container-22">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M15.4712 13.4424L12.0002 9.95638L8.52919 13.4424"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-23"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-24"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-25"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-26"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-27"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-28"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-29"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-30"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-31"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-32"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-33"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-34"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-35"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-36"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-37"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-38"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-39"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-40"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-41"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                ...
                <div className="icon-box">
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-42"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div id="svg-container-42">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M9.43164 14.5716L14.5716 9.43164"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-43"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-44"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-45"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-46"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-47"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-48"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-49"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-50"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-51"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-52"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-53"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-54"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-55"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-56"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-57"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-58"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-59"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-60"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-61"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-63"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-64"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-65"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-66"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-67"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-68"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-69"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-70"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-71"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-72"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-73"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-74"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-75"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-76"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-77"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-78"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-79"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-80"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-81"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-82"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                ...
                <div className="icon-box">
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-83"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div id="svg-container-83">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M13.864 13.8249L10.106 10.0669"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M10.106 13.8249L13.864 10.0669"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-84"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-85"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-86"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-87"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-88"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-89"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-90"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                ...
                <div className="icon-box">
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-91"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div id="svg-container-91">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M15.391 14.0178L12 11.9948V7.63379"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-92"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-93"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-94"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-95"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-96"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-97"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-98"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                ...
                <div className="icon-box">
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-99"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div id="svg-container-99">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M19.5845 5.90405C22.1345 9.57507 22.1429 14.4174 19.5845 18.0956"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-100"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-101"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-102"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-103"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
                  ...
                  <div className="overlay">
                    ...
                    >
                      <Button
                        variant="btn btn-sm btn-soft-primary"
                        data-toggle="copy"
                        data-copy-target="#svg-container-104"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Copy"
                      >
